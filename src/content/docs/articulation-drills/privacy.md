...
advertising, no tracking, and the app makes no network connection of its own.

## Information we collect

None. The app has no sign-up and no login. It never asks for a name, email
address, photograph, location, contact list, or any other personal information,
and it contains no code that transmits information anywhere.
...
The spoken words are audio files shipped inside the app and played from the
device. **The app does not record audio and does not use the microphone.**
...
The app includes no analytics services, advertising networks, social media
logins, or tracking technologies of any kind. Apple is the only third party
involved, solely to deliver the app and process the optional purchase.
...
Questions about this policy or about the app: **go@engineignite.com**.
